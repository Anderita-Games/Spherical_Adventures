...
public partial class SpecialCoinPickup : MonoBehaviour
{
    ...
    private const string CoinSoundWarning = "[SpecialCoinPickup] No coinSound assigned; assign a clip on the prefab.";
    ...
    private void PlayCoinSound()
    {
        ...
        GameObject go = new GameObject("SpecialCoinPickupOneShot");
        ...
        src.priority = 64;
        src.Play();
        Debug.Log("[SpecialCoinPickup] Played coin sound '" + this.coinSound.name + "' at volume " + this.coinVolume, this);
